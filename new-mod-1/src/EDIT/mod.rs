...
unsafe extern "C" fn mario_knee(agent: &mut L2CAgentBase) {
...
unsafe extern "C" fn mario_knee_fx(agent: &mut L2CAgentBase) {
...
pub fn install() {
    Agent::new("mario") 	// Replace "kirby" with character you want to modify, using their internal code name.
		// List of functions:
		.game_acmd("game_attackairf", mario_knee, Default)
		.effect_acmd("effect_attackairf", mario_knee_fx, Default)
